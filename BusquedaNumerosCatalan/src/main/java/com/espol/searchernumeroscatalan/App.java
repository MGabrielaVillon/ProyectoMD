...
public class App extends Application {
    ...
    public static int[][] mapaNumeros = new int[5][5];
    public static int[] listaNumeros = new int[6];
    ...
    private static int numeroCatalanCn(int n) {
        ...
        int denominador = factorial(n) * factorial(n+1);
    ...
    private GridPane createGameBoard() {
        ...
        gridPane.setHgap(6); // Espacio horizontal entre las celdas
        gridPane.setVgap(6); // Espacio vertical entre las celdas
